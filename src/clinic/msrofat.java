...
public final class msrofat extends javax.swing.JInternalFrame {
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
     ...
     dayyy="0"+dayyy;
           ...
           datee=date1.getText().toString(); 
            ...
            comment.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
               typename.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
    ...
    private void initComponents() {
        ...
        jPanel10.add(cmkind, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 60, 130, 30));

        delete.setBackground(new java.awt.Color(138, 203, 195));
        delete.setFont(new java.awt.Font("Arial", 1, 26)); // NOI18N
        delete.setText("مسح");
        ...
        jPanel10.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 530, 180, 50));

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel13.setText("نوع المصروف");
        jPanel10.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 60, 140, -1));

        jLabel18.setBackground(new java.awt.Color(255, 255, 255));
        jLabel18.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel18.setText("النوع");
        jPanel10.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 410, 90, 30));
        ...
        jPanel10.add(cmtype4, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 410, 210, 30));
        ...
        jPanel10.add(save1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 410, 100, 30));
        ...
        jLabel28.setText("اسم المصروف");
        jPanel10.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, 130, -1));

        cmtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
        jPanel10.add(cmtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 60, 210, 30));

        save.setBackground(new java.awt.Color(138, 203, 195));
        save.setFont(new java.awt.Font("Arial", 1, 26)); // NOI18N
        save.setText("حفظ");
        ...
        jPanel10.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 310, 180, 40));

        jLabel24.setBackground(new java.awt.Color(255, 255, 255));
        jLabel24.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel24.setText("القيمة");
        jPanel10.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 130, 60, 40));

        amount1.setEditable(false);
        amount1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel10.add(amount1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 470, 70, 30));

        jLabel25.setBackground(new java.awt.Color(255, 255, 255));
        jLabel25.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel25.setText("القيمة");
        jPanel10.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 470, 60, 30));

        jLabel17.setBackground(new java.awt.Color(255, 255, 255));
        jLabel17.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel17.setText("ملاحظة");
        jPanel10.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 210, 70, 60));

        jLabel14.setBackground(new java.awt.Color(255, 255, 255));
        jLabel14.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel14.setText("التاريخ");
        jPanel10.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 470, 80, 30));

        cmtype1.setEditable(true);
        cmtype1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
        jPanel10.add(cmtype1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 470, 210, 30));

        amount.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel10.add(amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 130, 70, 40));
        ...
        jPanel10.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 210, 310, 70));

        jLabel8.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        jPanel10.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 30, 570, 350));

        jLabel7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        jPanel10.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 270, 350));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
                       try
        {
             int amountt = Integer.parseInt(amount.getText());
                ...
                if(dialogResult == 0) {
                        try{
                            String sql = "INSERT INTO clinic.msrofat (kind,type,amount,comment,date,fulldatee) VALUES"
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
                           ...
                           try {
                String sql = "DELETE FROM clinic.msrofat WHERE (type='"+cmtype4.getSelectedItem().toString()+"' and fulldatee = '"+cmtype1.getSelectedItem().toString()+"');";
                pst=(PreparedStatement) con.prepareStatement(sql);
                pst.execute();
  ...
  if( typename.getText().trim().isEmpty() )
            ...
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO clinic.types (name) VALUES"
                        + " ('"+namee+"')";
                        pst = (PreparedStatement)con.prepareStatement(sql);
                        pst.execute();
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        ...
        try
        {
            ...
            String sqll="SELECT distinct fulldatee FROM clinic.msrofat  where 1=1 ";
        ...
        try {
            ...
            String sql="SELECT * FROM clinic.msrofat where 1=1 ";
...
public void msroffat()
   {
        try {
             String sql="SELECT name  FROM clinic.types ";
             pst=(PreparedStatement) con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
 ...
 public void comboxfromcombo1()
      {
            ...
            public void itemStateChanged(ItemEvent event) {
                ...
                Object item = event.getItem();
                 ...
                 try {
             String sql="SELECT * FROM clinic.msrofat where type='"+cmtype4.getSelectedItem().toString()+"' and fulldatee='"+cmtype1.getSelectedItem().toString()+"'";
             pst=(PreparedStatement) con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
