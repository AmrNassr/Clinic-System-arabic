...
headerLabel.setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        tdetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "كود الموظف", "الاسم", "قيمة السلفة", "المتبقي من الراتب", "التاريخ"
            }
        ));
        ...
        jPanel10.add(cmserial, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 40, 230, 30));

        jLabel8.setBackground(new java.awt.Color(255, 255, 255));
        jLabel8.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel8.setText("كود الموظف");
        jPanel10.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 40, 160, -1));

        jLabel11.setBackground(new java.awt.Color(255, 255, 255));
        jLabel11.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel11.setText("اسم الموظف");
        jPanel10.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 100, 160, -1));
        ...
        jPanel10.add(cmname, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 100, 240, 30));

        jLabel14.setBackground(new java.awt.Color(255, 255, 255));
        jLabel14.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel14.setText("قيمة السلفة");
        jPanel10.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 220, -1, -1));

        advanceamount.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel10.add(advanceamount, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 220, 90, 30));

        amount.setEditable(false);
        amount.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel10.add(amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 160, 90, 30));

        jLabel9.setBackground(new java.awt.Color(255, 255, 255));
        jLabel9.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel9.setText("المتبقي من الراتب");
        ...
        jPanel10.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, 120, 50));
...
String amount = advanceamount.getText();
  String name = cmname.getSelectedItem().toString();
             ...
             if(rs.next()){
                 ...
                 int remaining = remain - x;
                  String sql111 = "INSERT INTO clinic.advanceamount (name,serial,amount,remaining,date) VALUES "
                        ...
                        pst.execute();
                        JOptionPane.showMessageDialog(null, "تم تسجيل السلفة بنجاح");
                        clear();
                        tablelord();
                  }
                 else
    ...
    {
        JOptionPane.showMessageDialog(advanceamount, "المبلغ المطلوب اكبر من المتبقي من الراتب");
    }
