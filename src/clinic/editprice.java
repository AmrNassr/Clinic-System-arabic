...
Connection con ;
    ...
    private void initComponents() {
        ...
        pricex.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        pricex.setForeground(new java.awt.Color(255, 255, 255));
        pricex.setText("السعر");
        jPanel1.add(pricex, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 100, 60, 30));
        ...
        jPanel1.add(price, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 70, 30));

        jLabel17.setBackground(new java.awt.Color(255, 255, 255));
        jLabel17.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("كود المنتج");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 50, 140, 30));
        ...
        jPanel1.add(serial, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, 230, 30));
    ...
    private void serialKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_serialKeyPressed
         if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
             {
                 try {
                     String sqll = "SELECT * FROM clinic.item where serial ='"+serial.getText()+"'";
    ...
    try{
        ...
        try {
        String sqla = "UPDATE clinic.item SET price='"+x+"' where serial = '"+serial.getText()+"' ";
        pst=(PreparedStatement) con.prepareStatement(sqla);
        pst.executeUpdate();
        JOptionPane.showMessageDialog(this, "تم الحفظ");
        serial.setText("");
        price.setText("");
        serial.requestFocus();
    } catch (SQLException ex) {
    ...
    {
        JOptionPane.showMessageDialog(this, "السعر غير صحيح");
    }
