...
Connection con ;
    ...
    private void initComponents() {
        ...
        jLabel17.setText("اسم التخصص");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 90, 120, 40));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
         ...
         String namee = name.getText();
            ...
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO clinic.employeetypes (name) VALUES ('"+namee+"')";
                        ...
                        JOptionPane.showMessageDialog(null,"التخصص موجود مسبقا");
                        name.setText("");
                    }
