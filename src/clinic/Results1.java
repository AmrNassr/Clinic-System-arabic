...
public class Results1 extends javax.swing.JFrame {
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
    ...
    private void initComponents() {
        ...
        save1.setText("اظهار التحاليل");
        save1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                save1ActionPerformed(evt);
            }
        });
        jPanel1.add(save1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 160, 40));
        ...
        jPanel1.add(cancle, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 100, 30));

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("اسم المريض");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 90, 130, -1));

        cmtype.setEditable(true);
        cmtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
        jPanel1.add(cmtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 90, 240, 30));
        ...
        jPanel1.add(serial, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 200, -1, -1));
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        Results m = new Results(serial.getText());
            m.setVisible(true);
            this.dispose();
...
public void people()
   {
        try {
             String sql="SELECT name  FROM clinic.patient ";
    ...
    public void comboxfromcombo()
      {
            ...
            public void itemStateChanged(ItemEvent event) {
                ...
                Object item = event.getItem();
                     try {
             String sql="SELECT *  FROM clinic.patient where name='"+cmtype.getSelectedItem().toString()+"'";
             pst=(PreparedStatement) con.prepareStatement(sql);
             rs=pst.executeQuery();
             if(rs.next()){
