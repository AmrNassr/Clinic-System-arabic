...
public class patientdoctorattendance extends javax.swing.JFrame {
  Connection con ;  
    ...
    public patientdoctorattendance() {
        initComponents();
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
    ...
    private void initComponents() {
        ...
        jPanel1.add(cancle, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 210, 100, 30));

        save.setBackground(new java.awt.Color(98, 113, 146));
        save.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        save.setForeground(new java.awt.Color(255, 255, 255));
        save.setText("طباعه حضور المرضي");
        save.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveActionPerformed(evt);
            }
        });
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 160, 230, 40));
        ...
        jPanel1.add(cmtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 240, 30));

        jLabel9.setBackground(new java.awt.Color(255, 255, 255));
        jLabel9.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("من");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 70, 90, 30));
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 120, 80, 30));
    ...
    String typee=cmtype.getSelectedItem().toString();
     InputStream in=null;
      try {
           ...
           in = this.getClass().getResourceAsStream("/reports/attendance.jasper");
          String reportpath= "D:\\clinic\\attendance.jasper";
