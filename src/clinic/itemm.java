         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
    ...
    private void initComponents() {
        ...
        tdetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "كود المنتج", "اسم المنتج", "العدد", "السعر"
            }
        ));
        ...
        neww.setText("0");
        jPanel10.add(neww, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 140, 70, 30));

        jLabel22.setBackground(new java.awt.Color(255, 255, 255));
        jLabel22.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel22.setText("السعر");
        jPanel10.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 190, 90, -1));

        price.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        price.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        price.setText("0");
        jPanel10.add(price, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 190, 70, 30));

        jLabel20.setBackground(new java.awt.Color(255, 255, 255));
        jLabel20.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel20.setText("الجديد");
        jPanel10.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 140, 50, -1));

        jLabel19.setBackground(new java.awt.Color(255, 255, 255));
        jLabel19.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel19.setText("العدد");
        jPanel10.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 140, 60, -1));

        total.setEditable(false);
        total.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        total.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        total.setText("0");
        jPanel10.add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 140, 70, 30));

        name.setEditable(false);
        name.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel10.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 90, 210, 30));

        jLabel17.setBackground(new java.awt.Color(255, 255, 255));
        jLabel17.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel17.setText("الاسم");
        jPanel10.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 90, 70, 30));
        ...
        jPanel10.add(serial, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 30, 210, 30));

        jLabel18.setBackground(new java.awt.Color(255, 255, 255));
        jLabel18.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel18.setText("كود المنتج");
        jPanel10.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 30, 130, -1));
        ...
        jPanel10.add(save1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 170, 120, 50));
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        try
        {
            ...
            try {
                String sqlsdd="SELECT serial FROM clinic.item where serial='"+serial.getText()+"'";
               pst=(PreparedStatement) con.prepareStatement(sqlsdd);
               rs=pst.executeQuery();
               if(rs.next()){
                    String sqla = "UPDATE clinic.item SET total='"+all+"' where name = '"+namee+"' and serial = '"+serial.getText()+"'";
                  pst=(PreparedStatement) con.prepareStatement(sqla);
                  pst.executeUpdate();
                   String sqll4 = "INSERT INTO clinic.logs (type,serial,name,price,amount,date,fulldate,number) VALUES"
             ...
             pst.execute();
               ...
               {
                   String sqll3 = "INSERT INTO clinic.item (serial,name,price,total) VALUES"
    ...
    private void serialKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_serialKeyPressed
       if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
           try {
               String sqls="SELECT serial FROM clinic.item where serial='"+serial.getText()+"'";
               pst=(PreparedStatement) con.prepareStatement(sqls);
               rs=pst.executeQuery();
               if(rs.next()){
                String sqlsa="SELECT * FROM clinic.item where serial='"+serial.getText()+"'";
...
{
    try {
           String sqll = "SELECT * FROM clinic.item";
