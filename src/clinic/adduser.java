...
public final class adduser extends javax.swing.JInternalFrame {
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
    ...
    private void initComponents() {
        ...
        jPanel10.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 430, 100, 30));
        ...
        jPanel10.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 360, 160, 50));

        type.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Dat Entry", "admin" }));
        jPanel10.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 300, 250, 40));
        jPanel10.add(pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 240, 250, 40));
        jPanel10.add(user, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 250, 40));

        jLabel5.setBackground(new java.awt.Color(0, 0, 0));
        jLabel5.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel5.setText("اسم المستخدم");
        jPanel10.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 130, 180, 90));

        jLabel6.setBackground(new java.awt.Color(0, 0, 0));
        jLabel6.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel6.setText("كلمة السر");
        jPanel10.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 210, 190, 90));

        jLabel12.setBackground(new java.awt.Color(255, 255, 255));
        jLabel12.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel12.setText("النوع");
        jPanel10.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 290, 80, 60));
...
clear();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else
        {
            ...
            try{
                String sql = "INSERT INTO clinic.users (username, password, type) VALUES"
