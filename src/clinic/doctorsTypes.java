...
public class doctorsTypes extends javax.swing.JFrame {
Connection con ;
    ...
    public doctorsTypes() throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel17.setText("التخصص الطبي");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 90, 160, 40));

        name.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jPanel1.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 260, 40));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, 120, 40));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
         ...
         String namee = name.getText();
            ...
            {
                JOptionPane.showMessageDialog(this, "من فضلك ادخل اسم التخصص");
            }
            else
            {
                int dialogButton = JOptionPane.YES_NO_OPTION;
                int dialogResult = JOptionPane.showConfirmDialog(this, "حفظ ?", "رسالة تاكيد", dialogButton);
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO clinic.doctor_types (name) VALUES ('"+namee+"')";
                        pst = (PreparedStatement)con.prepareStatement(sql);
                        pst.execute();
                        JOptionPane.showMessageDialog(null, "تم اضافة التخصص بنجاح");
                        name.setText("");
                        
                    }
                    catch(Exception e ){
                        JOptionPane.showMessageDialog(null,"التخصص موجود من قبل");
                        name.setText("");
                    }
